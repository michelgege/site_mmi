...
<div id="wrap_body">
	...
	<div id="scene" class="scene">
		...
		<div  class="layer" data-depth="0.30">
			<img src="<?php echo get_template_directory_uri() ?>/img/pro_red_square_3.svg" id="red_square">
		</div> 
		<div  class="layer" data-depth="-0.20">
			<img src="<?php echo get_template_directory_uri() ?>/img/pro_white_triangle_3.svg" id="white_triangle_three">
		</div> 
		<div  class="layer" data-depth="0.60">
			<img src="<?php echo get_template_directory_uri() ?>/img/pro_border_grey_triangle_3.svg" id="border_grey_triangle">
		</div>

		<div  class="layer" data-depth="-.90">
			<img src="<?php echo get_template_directory_uri() ?>/img/pro_border_white_triangle_4.svg" id="border__white_triangle_four">
		</div> 
		<div  class="layer" data-depth="0.70">
			<img src="<?php echo get_template_directory_uri() ?>/img/pro_white_triangle_big_4.svg" id="white_triangle_four_big">
		</div> 
		<div  class="layer" data-depth="0.10">
			<img src="<?php echo get_template_directory_uri() ?>/img/pro_white_triangle_small_4.svg" id="white_triangle_four_small">
		</div>
	...
	<img src="<?php echo get_template_directory_uri() ?>/img/form_shape.svg" id="form_shape">
